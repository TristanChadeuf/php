...
<form action="index.php?contenu=contact" method="post" enctype="multipart/form-data">
  Selection une image:
...
if(move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],$target_file)){
    echo "Le fichier". htmlspecialchars (basename($_FILES["fileToUpload"]["name"] ))."Peut etre telecharger";
}else{
    echo "va te faire foutre Moumen";
}
